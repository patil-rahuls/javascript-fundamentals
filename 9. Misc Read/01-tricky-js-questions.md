...
Problem 1: Assign certain value to the variable `a` such that the following condition evaluates to `true`.
`(a == 1 && a == 2 && a == 3)`
Solution:
...
Problem 2: What will be the output of this program?
...
Problem 3: Group Array items by a property.
...
Problem 4: What will be the output of this program?
...
Problem 5: What will be the output of this program.
