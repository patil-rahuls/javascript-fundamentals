...
// Scenarios, when checking nested objects, we might come to
// a point where we have to check if a property/method exists,
// and if it exists, call/return its value.
// But then our code gets really messy and cluttered.

// Directly accessing a property which we don't know whether
// exists or not is a bad idea.
console.log(restaurant.workingHours.fri.open);
// If obj "fri" doesn't exist,
// we get error: "cannot read property of type 'undefined'"
...
console.log(restaurant.openingHours?.fri?.open);
// returns undefined instead of the error if evaluation
// before ? results falsy
