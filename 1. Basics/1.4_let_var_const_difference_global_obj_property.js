...
// Variables declared using *let* and *const* are not accessible
// to global objects like the *window* or *global* object.
// The purpose of *let* and *const* statements is only to
// free up memory when not needed in a certain block.
