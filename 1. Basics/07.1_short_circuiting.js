...
// Better Solution:
// We can use short circuiting the OR operator to shorten
// the above code.
const val2 = myObj.property1 || 10;
// If first operand is falsy,
// we will have default value 10 assigned to val2.
...
// then the second expression calcSq(34) will be executed.
