...
Takes the value of _(points to)_ the "owner" of the function in which it is used.
...
> myObj.myFunction();
> ```
> When the this method is called, then it's `this` object will point to 'myObj'.
>
