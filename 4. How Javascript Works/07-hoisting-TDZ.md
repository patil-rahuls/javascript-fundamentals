...
> Before Execution of a block/function, code is scanned for variable declarations and for each variable, a new uninitialized property(without any value) is created in the Variable Environment, **(and memory is allocated)**.
