...
> Primtives are stored in the CALL STACK

> The Reference values are objects and are stored in the HEAP.
...
_They hold reference to the Object stored in Heap. Hence, any changes to be made to the Object (user.age = 30;) are done in the Heap, and not in the Call Stack._
...
▶️ [Event Loop](09.1-event-loop.md)
