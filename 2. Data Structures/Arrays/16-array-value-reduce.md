...
>   
>   - _It keeps holding and/or changing a value throughout the iterations._
>   
>   - _On every iteration, a value needs to be returned which goes to the accumulator, it can be the 'acc' or any calculations with acc._

> Example: _Same example using arrow fn._
> 
> ```javascript
...
>
> _IMP - We need to return something in the callback which will go into the accumulator._
>
