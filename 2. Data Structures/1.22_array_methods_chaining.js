...
// A big advantage of using these functions over traditional
// loops is that we can chain these functions together.
...
// But if any error occurs, it's hard to guess from where that
// error came in this pipeline.
// To monitor errors we can check arrays returned at each step
// in this pipeline.
// Remember we have the third parameter in the Callback function
// of each of these methods which gives the entire array.
...
// 2. Never chain methods that mutate the underlying arrays
//    (like splice() or reverse()) in large applications.
