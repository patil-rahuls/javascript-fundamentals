...
// A big advantage of using these functions over traditional loops
// is that we can chain these functions together in one statement.

// reduce() boils down all the array values to one single value.
...
// In the Callback function 'acc' is a new parameter here
// which is an accumulator.
//    It accumulates the data on every Iteration.
//    It keeps holding and/or changing a value throughout
//    the iterations.
//    A value needs to be returned (on every iteration).
//    It can be the 'acc' Or any calculations with acc.
...
// IMP - We need to return something in the callback
// which will go into the accumulator.
