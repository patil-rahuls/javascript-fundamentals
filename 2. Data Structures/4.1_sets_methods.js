...
// That's the only distinction in their methods.
names.add("anil");
names.add("milan");
console.log(names);
...
// Because, there is no order(index) defined in which the items
// are stored in a Set unlike arrays. When using Sets, we just
// care about uniqueness and whether the item is present or
// not(in the Set).
