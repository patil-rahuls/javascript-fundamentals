...
// If we need to compute the property name then of course
// we need to use the "BRACKET" notation.
// Else use the easier and straightforward DOT notation.

// Example (Optional):
// get property from a prompt
const selected = prompt("Choose: a, b, c.", "b");

// Log respective value of the property from object.
console.log ( myObj.selected ) ;
// undefined.
console.log ( myObj[selected] ) ;
