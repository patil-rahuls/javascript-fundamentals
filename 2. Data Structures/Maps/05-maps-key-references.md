## Data Structures > Map > Keys References
...
_In the above example, the array **[1,2]** passed to **myMap.get()** and the array used in **myMap.set()** are at different locations in Heap._
