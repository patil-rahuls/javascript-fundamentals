...
// two consecutive elements of the given array.
// If the callback function returns positive,
// then the two consecutive elements are swapped.
// if it returns negative value, the elements remain as is.

const arr2 = [200, 450, -400, 3000, -650, -130, 70, 1300];
arr2.sort((a,b) => {
   if(a<b) return -1;
   // position of a and b remain same in the array.(a,b)
   if(a>b) return 1;
