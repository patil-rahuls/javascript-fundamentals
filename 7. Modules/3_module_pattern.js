...
// module. The displayMessage() function is part of the public
// API, so it can be accessed from outside the module.

// When we call myModule.displayMessage(), the displayMessage()
// function calls the private showMessage() function, which
// displays the message "Hello World!" in the console.

// The Module Pattern allows us to create reusable and
// encapsulated code, avoiding potential naming conflicts with
// other parts of our code.
// It also helps to keep our code organized and easier to
// maintain by hiding implementation details.

//////////////////////////////////////////////////////////////
// And this is how are modules implemented inside/behind the
// scenes. By writing an IIFE which returns(exports) only
...
ShoppingCart.addToCart("item1", 10);
ShoppingCart.addToCart("item2", 2);
ShoppingCart.addToCart("item3", 1);
// The array ShoppingCart.cart keeps getting updated.

console.log(ShoppingCart.getCart());
// Observe, that by now, the IIFE has been executed, but still
// the array "ShoppingCart.cart" keeps getting updated,
