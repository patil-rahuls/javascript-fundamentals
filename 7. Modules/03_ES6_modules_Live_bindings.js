...
// (also called "live binding"). If the original file updates
...
console.log(count); // 0
increment();        // Called the function from the other file
...
// The value can only be re-assigned by the module which is
// exporting it.

// In the above example, if you try to do count = 10 inside
// app.js, JavaScript will throw a
// TypeError: Assignment to constant variable.
// You can only change it by calling a function
// (like increment) that lives inside the original module.
