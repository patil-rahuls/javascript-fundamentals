...
//  Example #1 - Read a file "synchronously" using the fs.readFile() method
import fs from 'fs';
const fileData = fs.readFile('2_npm.md', 'utf8');
console.log(fileData);

//  Example #2 - Read a file "asynchronously" usng async-await.
import { readFile } from 'fs/promises';
try {
    const data = await readFile('2_npm.md');
