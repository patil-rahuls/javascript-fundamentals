...
// Earlier we saw how we deal with inheritance using
// constructor functions.
// 1. Create Parent constructor Fn.
// 2. Create Child constructor Fn.
...
// AS SIMPLE AS THAT
// constructor() is mandatory in parent class or any regular
// ES6 class, but can be omitted in child class if child class
// need to have exact same number and name of parameters.
// super() -> call to parent class' constructor function.
// It is necessary with extends.
