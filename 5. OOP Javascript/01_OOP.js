...
// OOP's goal is to organize code, make it flexible and easier
// to maintain.
...
// A *Prototype Object* contains properties(states) and
// methods (behaviours) that are accessible to all objects
// linked to it.
// This is called Prototypal Inheritance.
// (This is different than the Inheritance in Java/PHP/C++)

// DELEGATION:
// Behaviour(method) is delagated to the linked *Prototype Object*.
// Whereas in classic OOP, the methods are actually *copied*
// from the class to all instances.
...
// are actualy implemented.
// new Array(...), new Set(...) , new Map(...)
// These are all constructer function calls.
...
// a prototype object.
// We directly create the *Prototype Object* and
// link object(instance) to it.

// Note that the 4 pillars of OOP are still valid with
