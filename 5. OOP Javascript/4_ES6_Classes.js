...
// *Classes* in ES6 javascript are just syntactic sugars to
...
// Classes in Javascript actually hide the true nature of
// prototypal inheritance
// 1. Class declarations are not hoisted.
// 2. Like functions, classes are also first class citizens.
//      that means, we can pass them to functions and
//      return them from functions.
//      This happens because classes are basically Contructor
//      Functions behind the scenes and Constructor Functions
//      are still functions(special kind).
// 3. Classes are executed in "strict mode" even though
//      u haven't activated the strict mode.

// Constructor functions vs ES6 Classes ?
// Its a personal preference.
// Classes looks a lot better as everything is in one block,
// Even though the class's methods point to .prototype
// property, still they are kept inside class,
