...
// IMP: Arrow Functions are not used to create constructor
// functions, because they don't have their own 'this' keyword.

// We create a constructor function like a regular function.
// The only conventional distinction is that the first letter
// is capital and we get a *this* keyword inside it.
...
// 'this' in the Student constructor function
// refers to the object 'stu'.
...
// "Student.prototype" is NOT the *Prototype Object* of
// Student constructor function. It is a prototype of objects
// created using Student constructor function, i.e. "stu".
...
// In Javascript, any object's *Prototype* is actually *__proto__*
// property. So, "stu.__proto__" i.e. "Student.prototype" is a
// *Prototype* of "stu" Object. And this way, an object is linked
// to the Constructor function's prototype property.

// So here are the 4 events that happen.

// 1. An {} empty obj ("stu") is created.
// 2. 'this' keyword in the Constructor function call is set to
//    the newly created object "stu".
//    That means, the 'this' object inside the execution context
//    of the constructor fn now points to that new object "stu".
// 3. The new object "stu" is linked to the constructor function's
//    prototype property as a result of creation of a new property
//    called *__proto__* property.
// 4. The new object "stu" is returned from the constructor
//    function call.
...
const ExStudent = function (name , rollNo) {
    ...
    // NEVER DO THIS - Because if we create 1000s of
